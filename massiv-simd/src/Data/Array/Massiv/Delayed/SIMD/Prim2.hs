...
--
module Data.Array.Massiv.Delayed.SIMD.Prim2 where
...
data Step e = YieldV {-# UNPACK #-} !Int# {-# UNPACK #-} !DoubleX2#
            | YieldE {-# UNPACK #-} !Int# {-# UNPACK #-} !Double#
            | Done
