...
-- | /O(n)/ - Convert an array into a nested list. Array dimensions and list nestedness will always
-- match, but you can use `toList`, `toLists2`, etc. if flattening of inner dimensions is desired.
--
